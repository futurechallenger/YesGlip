...
class Signature {
  ...
  Signature(this._signatureMethod, this._method, this._url, this._additionalParameters);
  ...
  String toString() {
    ...
    final s = _createSignature(_method, _url, params);
  ...
  String _createSignature(
    ...
    final String signingKey =
        '${Uri.encodeComponent('Fa9uZcT2O27nCZUeTjySGeTe3v5zHUfRfhskfKJjTe0=')}&';
